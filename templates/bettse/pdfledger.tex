...
\includegraphics[width=0.8\linewidth, keepaspectratio=true]{build/checking-1yearbalance}\\[1cm]    


Balance during \monthname :

\includegraphics[width=0.8\linewidth, keepaspectratio=true]{build/checking-1monthbalance}\\[1cm]    
...
\includegraphics[width=0.8\linewidth, keepaspectratio=true]{build/checking-1forecast}\\[1cm]    
